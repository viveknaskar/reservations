...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, CHECK_IN_DATE, CHECK_OUT_DATE, STATUS) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2017-01-01', '2017-01-03', 'CONFIRMED');
