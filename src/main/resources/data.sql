-- 1Q = 1 Queen (89/night, capacity 2), 2D = 2 Double (129/night, capacity 4), 1K = 1 King (109/night, capacity 2)
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P1', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P2', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P3', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P4', '2D', 129.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P5', '2D', 129.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Piccadilly', 'P6', '2D', 129.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Cambridge', 'C1', '1K', 109.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Cambridge', 'C2', '1K', 109.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Cambridge', 'C3', '1K', 109.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W1', '1K', 119.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W2', '1K', 119.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W3', '1K', 119.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W4', '1K', 119.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W5', '2D', 149.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W6', '2D', 149.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Westminster', 'W7', '2D', 149.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Oxford', 'O1', '1K', 109.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Oxford', 'O2', '1K', 109.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Oxford', 'O3', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Oxford', 'O4', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Oxford', 'O5', '1Q', 89.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Victoria', 'V1', '1K', 119.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Victoria', 'V2', '2D', 149.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Victoria', 'V3', '2D', 149.00, 4);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Manchester', 'M1', '1K', 99.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Manchester', 'M2', '1K', 99.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Manchester', 'M3', '1K', 99.00, 2);
INSERT INTO ROOM (NAME, ROOM_NUMBER, BED_INFO, PRICE_PER_NIGHT, MAX_CAPACITY) VALUES ('Manchester', 'M4', '1K', 99.00, 2);
...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, GUEST_COUNT, CHECK_IN_DATE, CHECK_OUT_DATE, STATUS, TOTAL_PRICE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), 2, '2017-01-01', '2017-01-03', 'CONFIRMED', 218.00);
INSERT INTO RESERVATION_NIGHT (RESERVATION_ID, ROOM_ID, STAY_DATE) VALUES ((SELECT RESERVATION_ID FROM RESERVATION WHERE ROOM_ID = (SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2') AND CHECK_IN_DATE = '2017-01-01'), (SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), '2017-01-01');
INSERT INTO RESERVATION_NIGHT (RESERVATION_ID, ROOM_ID, STAY_DATE) VALUES ((SELECT RESERVATION_ID FROM RESERVATION WHERE ROOM_ID = (SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2') AND CHECK_IN_DATE = '2017-01-01'), (SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), '2017-01-02');
